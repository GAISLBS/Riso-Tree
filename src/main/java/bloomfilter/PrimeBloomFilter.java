...
public class PrimeBloomFilter {
     ...
     * @param size size of the bloom filter bitmap
     * @param k number of hash functions
     * @param range range of the numbers
     */
    public PrimeBloomFilter(int size, int k, int range) {
    ...
    public long[] toLongArray() {return bitMap.toLongArray();}
