...
//		offset += (nblocks << 4); // nblocks * 16;
    ...
    /**
     * Compute the Murmur3 hash for a single int value.
     *
     * @param value the int value to hash
     * @param seed  the seed to use for the hash calculation
     * @return the computed hash value as an int
     */
    public static int hashInt(int value, int seed) {
        ...
        // Finalization
        return fmix(h1, Integer.BYTES); // Integer.BYTES is equal to 4
    }
